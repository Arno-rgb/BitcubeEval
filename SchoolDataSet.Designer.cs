...
namespace Student_Management_System {
    ...
    public partial class SchoolDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string first_name, string last_name, string middle_name, string degree, System.DateTime date_of_birth) {
...
namespace Student_Management_System.SchoolDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Student_id] = @Original_Student_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ((@IsNull_middle_name = 1 AND [middle_name] IS NULL) OR ([middle_name] = @Original_middle_name)) AND ([degree] = @Original_degree) AND ([date_of_birth] = @Original_date_of_birth))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([first_name], [last_name], [middle_name], [degree], [date_of_birth]) VALUES (@first_name, @last_name, @middle_name, @degree, @date_of_birth);
SELECT Student_id, first_name, last_name, middle_name, degree, date_of_birth FROM Student WHERE (Student_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [first_name] = @first_name, [last_name] = @last_name, [middle_name] = @middle_name, [degree] = @degree, [date_of_birth] = @date_of_birth WHERE (([Student_id] = @Original_Student_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ((@IsNull_middle_name = 1 AND [middle_name] IS NULL) OR ([middle_name] = @Original_middle_name)) AND ([degree] = @Original_degree) AND ([date_of_birth] = @Original_date_of_birth));
SELECT Student_id, first_name, last_name, middle_name, degree, date_of_birth FROM Student WHERE (Student_id = @Student_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Student_id, first_name, last_name, middle_name, degree, date_of_birth FROM" +
                " dbo.Student";
        ...
        public virtual int Delete(int Original_Student_id, string Original_first_name, string Original_last_name, string Original_middle_name, string Original_degree, System.DateTime Original_date_of_birth) {
        ...
        public virtual int Insert(string first_name, string last_name, string middle_name, string degree, System.DateTime date_of_birth) {
            if ((first_name == null)) {
        ...
        public virtual int Update(string first_name, string last_name, string middle_name, string degree, System.DateTime date_of_birth, int Original_Student_id, string Original_first_name, string Original_last_name, string Original_middle_name, string Original_degree, System.DateTime Original_date_of_birth, int Student_id) {
            if ((first_name == null)) {
                throw new global::System.ArgumentNullException("first_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first_name, string last_name, string middle_name, string degree, System.DateTime date_of_birth, int Original_Student_id, string Original_first_name, string Original_last_name, string Original_middle_name, string Original_degree, System.DateTime Original_date_of_birth) {
            return this.Update(first_name, last_name, middle_name, degree, date_of_birth, Original_Student_id, Original_first_name, Original_last_name, Original_middle_name, Original_degree, Original_date_of_birth, Original_Student_id);
        }
    }
